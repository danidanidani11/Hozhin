...
ABOUT_BOOK_TEXT = """..."""  # ✅ برای کوتاه کردن نمایش، محتوای طولانی حذف شده
ABOUT_AUTHOR_TEXT = """..."""
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "buy":
        ...
        msg = (
            "اگر درباره کتاب پیشنهاد یا انتقادی دارید، حتما بنویسید:\n"
    ...
    if data.startswith("approve_") or data.startswith("reject_"):
        ...
        if data.startswith("approve_"):
            ...
            if os.path.exists(pdf_path):
                ...
                await context.bot.send_message(chat_id=ADMIN_ID, text="❌ فایل PDF پیدا نشد.")
...
def run_app():
    ...
    # 🔧 مهم: اول دکمه‌های تایید/رد فیش
    application.add_handler(CallbackQueryHandler(admin_callback_handler, pattern=r"^(approve_|reject_)\d+$"))
